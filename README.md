...
```groovy
dependencies {
    compile group: "org.http4k", name: "http4k-core", version: "3.179.0"
    compile group: "org.http4k", name: "http4k-server-jetty", version: "3.179.0"
    compile group: "org.http4k", name: "http4k-client-okhttp", version: "3.179.0"
}
```
